...
export const Hero = ({
  ...
  return (
    <div
      className="relative flex w-full flex-col overflow-hidden bg-cover bg-[center_65%] p-12 text-white sm:px-16 lg:px-14 lg:py-40 xl:px-20"
      style={{
        backgroundImage: `
...
export const MainHero = ({
  ...
  return (
    <div
      className="relative flex min-h-[clamp(900px,40vh,50vh)] w-full flex-col overflow-hidden bg-cover bg-[center_65%] px-6 pb-16 pt-[12%] text-white md:px-14 xl:pl-36 xl:pr-96"
      style={{
        backgroundImage: `
          linear-gradient(135deg, rgb(17 24 39) 0%, rgb(243 244 246) 100%),
          radial-gradient(circle at 0% 0%, #060839 0%, transparent 85%),
